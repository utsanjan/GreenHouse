...
public class MyPostsActivity extends AppCompatActivity {
    ...
    private void DisplayAllPosts() {
        ...
        Query myPostQuery = startAt.endAt(this.currentUserId + "\uf8ff");
        FirebaseRecyclerAdapter<Posts, MyPostViewHolder> firebaseRecyclerAdapter = new AnonymousClass1(Posts.class, R.layout.all_post_layout, MyPostViewHolder.class, myPostQuery);
        this.myPostLists.setAdapter(firebaseRecyclerAdapter);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: com.example.instagram.MyPostsActivity$1  reason: invalid class name */
    /* loaded from: classes.dex */
    public class AnonymousClass1 extends FirebaseRecyclerAdapter<Posts, MyPostViewHolder> {
        ...
        /* JADX INFO: Access modifiers changed from: protected */
        public void populateViewHolder(MyPostViewHolder viewHolder, Posts model, int i) {
            final String PostKey = getRef(i).getKey();
            viewHolder.setFullname(model.getFullname());
            viewHolder.setTime(model.getTime());
            viewHolder.setDate(model.getDate());
            viewHolder.setDescription(model.getDescription());
            viewHolder.setProfileimage(MyPostsActivity.this.getApplicationContext(), model.getProfileimage());
            viewHolder.setPostimage(MyPostsActivity.this.getApplicationContext(), model.getPostimage());
            viewHolder.setLikeButtonStatus(PostKey);
            viewHolder.mView.setOnClickListener(new View.OnClickListener() { // from class: com.example.instagram.MyPostsActivity.1.1
                @Override // android.view.View.OnClickListener
                public void onClick(View v) {
                    Intent clickPostIntent = new Intent(MyPostsActivity.this, ClickPostActivity.class);
                    clickPostIntent.putExtra("PostKey", PostKey);
                    MyPostsActivity.this.startActivity(clickPostIntent);
                }
            });
            viewHolder.CommentPostButton.setOnClickListener(new View.OnClickListener() { // from class: com.example.instagram.MyPostsActivity.1.2
                @Override // android.view.View.OnClickListener
                public void onClick(View v) {
                    Intent commentsIntent = new Intent(MyPostsActivity.this, CommentsActivity.class);
                    commentsIntent.putExtra("PostKey", PostKey);
                    MyPostsActivity.this.startActivity(commentsIntent);
                }
            });
            viewHolder.LikePostButton.setOnClickListener(new View.OnClickListener() { // from class: com.example.instagram.MyPostsActivity.1.3
                @Override // android.view.View.OnClickListener
                public void onClick(View v) {
                    MyPostsActivity.this.LikeChecker = true;
                    MyPostsActivity.this.LikesRef.addValueEventListener(new ValueEventListener() { // from class: com.example.instagram.MyPostsActivity.1.3.1
                        private DataSnapshot dataSnapshot;

                        @Override // com.google.firebase.database.ValueEventListener
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            this.dataSnapshot = dataSnapshot;
                            if (!MyPostsActivity.this.LikeChecker.equals(true)) {
                                return;
                            }
                            if (dataSnapshot.child(PostKey).hasChild(MyPostsActivity.this.currentUserId)) {
                                MyPostsActivity.this.LikesRef.child(PostKey).child(MyPostsActivity.this.currentUserId).removeValue();
                                MyPostsActivity.this.LikeChecker = false;
                                return;
                            }
                            MyPostsActivity.this.LikesRef.child(PostKey).child(MyPostsActivity.this.currentUserId).setValue(true);
                            MyPostsActivity.this.LikeChecker = false;
                        }
    ...
    public static class MyPostViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setLikeButtonStatus(final String PostKey) {
            this.LikesRef.addValueEventListener(new ValueEventListener() { // from class: com.example.instagram.MyPostsActivity.MyPostViewHolder.1
                @Override // com.google.firebase.database.ValueEventListener
                public void onDataChange(DataSnapshot dataSnapshot) {
