...
public abstract class zzt {
    ...
    public static final class zzb extends Enum<zzb> {
        ...
        static {
            zzb zzbVar = new zzb("COMBINED", 20, 100);
            zzu = zzbVar;
            zzb[] zzbVarArr = {zza, zzb, zzc, zzd, zze, zzf, zzg, zzh, zzi, zzj, zzk, zzl, zzm, zzn, zzo, zzp, zzq, zzr, zzs, zzt, zzbVar};
    ...
    public static final class zzc extends Enum<zzc> {
        ...
        static {
            zzc zzcVar = new zzc("NONE", 18, -1);
            zzs = zzcVar;
            zzc[] zzcVarArr = {zza, zzb, zzc, zzd, zze, zzf, zzg, zzh, zzi, zzj, zzk, zzl, zzm, zzn, zzo, zzp, zzq, zzr, zzcVar};
