...
public final class zaq implements zabr {
    ...
    public static zaq zaa(Context context, zaaw zaawVar, Lock lock, Looper looper, GoogleApiAvailabilityLight googleApiAvailabilityLight, Map<Api.AnyClientKey<?>, Api.Client> map, ClientSettings clientSettings, Map<Api<?>, Boolean> map2, Api.AbstractClientBuilder<? extends zac, SignInOptions> abstractClientBuilder, ArrayList<zap> arrayList) {
        ...
        while (i < size) {
            ...
            } else if (arrayMap4.containsKey(zapVar2.mApi)) {
    ...
    */
    public final boolean isConnected() {
        /*
            ...
            r0.lock()
            com.google.android.gms.common.api.internal.zabe r0 = r2.zaei     // Catch: all -> 0x0028
            boolean r0 = r0.isConnected()     // Catch: all -> 0x0028
            r1 = 1
            if (r0 == 0) goto L_0x0021
            com.google.android.gms.common.api.internal.zabe r0 = r2.zaej     // Catch: all -> 0x0028
            boolean r0 = r0.isConnected()     // Catch: all -> 0x0028
            if (r0 != 0) goto L_0x0020
            boolean r0 = r2.zax()     // Catch: all -> 0x0028
            if (r0 != 0) goto L_0x0020
            int r0 = r2.zaes     // Catch: all -> 0x0028
