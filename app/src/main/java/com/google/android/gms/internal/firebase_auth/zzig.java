...
public final class zzig extends zzgr<Integer> implements zzim, zzka, RandomAccess {
    ...
    public final boolean equals(Object obj) {
        ...
        if (this.zzc != zzigVar.zzc) {
            return false;
        }
        int[] iArr = zzigVar.zzb;
    ...
    public final boolean addAll(Collection<? extends Integer> collection) {
        ...
        if (Integer.MAX_VALUE - i2 >= i) {
            ...
            System.arraycopy(zzigVar.zzb, 0, this.zzb, this.zzc, zzigVar.zzc);
            this.zzc = i3;
            this.modCount++;
            return true;
        }
    ...
    static {
        zzig zzigVar = new zzig(new int[0], 0);
        zza = zzigVar;
        zzigVar.zzb();
    }
}
