...
public interface zzke {
    ...
    <T> T zza(zzkd<T> zzkdVar, zzhs zzhsVar) throws IOException;

    void zza(List<Double> list) throws IOException;

    <T> void zza(List<T> list, zzkd<T> zzkdVar, zzhs zzhsVar) throws IOException;

    <K, V> void zza(Map<K, V> map, zzji<K, V> zzjiVar, zzhs zzhsVar) throws IOException;

    int zzb();

    @Deprecated
    <T> T zzb(zzkd<T> zzkdVar, zzhs zzhsVar) throws IOException;

    void zzb(List<Float> list) throws IOException;

    @Deprecated
    <T> void zzb(List<T> list, zzkd<T> zzkdVar, zzhs zzhsVar) throws IOException;
