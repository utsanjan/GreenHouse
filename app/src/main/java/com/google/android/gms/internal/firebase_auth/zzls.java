...
interface zzls {
    ...
    void zza(int i, zzgv zzgvVar) throws IOException;

    <K, V> void zza(int i, zzji<K, V> zzjiVar, Map<K, V> map) throws IOException;

    void zza(int i, Object obj) throws IOException;

    void zza(int i, Object obj, zzkd zzkdVar) throws IOException;

    void zza(int i, String str) throws IOException;

    void zza(int i, List<String> list) throws IOException;

    void zza(int i, List<?> list, zzkd zzkdVar) throws IOException;
    ...
    @Deprecated
    void zzb(int i, Object obj, zzkd zzkdVar) throws IOException;

    void zzb(int i, List<zzgv> list) throws IOException;

    @Deprecated
    void zzb(int i, List<?> list, zzkd zzkdVar) throws IOException;
