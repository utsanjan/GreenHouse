...
public interface zzhm {
    ...
    <T> T zza(zzhp<T> zzhpVar, zzfb zzfbVar) throws IOException;

    void zza(List<Double> list) throws IOException;

    <T> void zza(List<T> list, zzhp<T> zzhpVar, zzfb zzfbVar) throws IOException;

    <K, V> void zza(Map<K, V> map, zzgr<K, V> zzgrVar, zzfb zzfbVar) throws IOException;

    int zzb();

    @Deprecated
    <T> T zzb(zzhp<T> zzhpVar, zzfb zzfbVar) throws IOException;

    void zzb(List<Float> list) throws IOException;

    @Deprecated
    <T> void zzb(List<T> list, zzhp<T> zzhpVar, zzfb zzfbVar) throws IOException;
    ...
    void zzk(List<zzeg> list) throws IOException;
