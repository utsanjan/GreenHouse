...
final class zzee extends zzea<Boolean> implements zzfx<Boolean>, zzhi, RandomAccess {
    private static final zzee zza;
    private boolean[] zzb;
    private int zzc;
    ...
    private zzee(boolean[] zArr, int i) {
        this.zzb = zArr;
        this.zzc = i;
    }
    ...
    public final /* synthetic */ zzfx<Boolean> zza(int i) {
        if (i >= this.zzc) {
            return new zzee(Arrays.copyOf(this.zzb, i), this.zzc);
        }
    ...
    static {
        zzee zzeeVar = new zzee(new boolean[0], 0);
        zza = zzeeVar;
        zzeeVar.zzb();
    }
}
