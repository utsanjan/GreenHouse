...
interface zzja {
    ...
    void zza(int i, zzeg zzegVar) throws IOException;

    <K, V> void zza(int i, zzgr<K, V> zzgrVar, Map<K, V> map) throws IOException;

    void zza(int i, Object obj) throws IOException;

    void zza(int i, Object obj, zzhp zzhpVar) throws IOException;

    void zza(int i, String str) throws IOException;

    void zza(int i, List<String> list) throws IOException;

    void zza(int i, List<?> list, zzhp zzhpVar) throws IOException;
    ...
    @Deprecated
    void zzb(int i, Object obj, zzhp zzhpVar) throws IOException;

    void zzb(int i, List<zzeg> list) throws IOException;

    @Deprecated
    void zzb(int i, List<?> list, zzhp zzhpVar) throws IOException;
