...
public final class zzj implements CredentialsApi {
    ...
    public final PendingIntent getHintPickerIntent(GoogleApiClient googleApiClient, HintRequest hintRequest) {
        ...
        Auth.AuthCredentialsOptions zze = ((zzq) googleApiClient.getClient(Auth.zzg)).zze();
        return zzr.zzc(googleApiClient.getContext(), zze, hintRequest, zze.getLogSessionId());
    }
