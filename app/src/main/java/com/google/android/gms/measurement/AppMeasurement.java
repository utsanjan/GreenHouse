...
public class AppMeasurement {
    ...
    public static class ConditionalUserProperty {
        ...
        ConditionalUserProperty(Bundle bundle) {
            ...
            this.mActive = ((Boolean) zzgx.zza(bundle, AppMeasurementSdk.ConditionalUserProperty.ACTIVE, Boolean.class, false)).booleanValue();
    ...
    public Map<String, Object> getUserProperties(boolean z) {
        ...
        List<zzkq> zzb = this.zzb.zzh().zzb(z);
        ArrayMap arrayMap = new ArrayMap(zzb.size());
        for (zzkq zzkqVar : zzb) {
