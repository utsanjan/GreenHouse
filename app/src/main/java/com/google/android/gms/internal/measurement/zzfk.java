...
final class zzfk extends zzea<Float> implements zzfx<Float>, zzhi, RandomAccess {
    ...
    public final boolean equals(Object obj) {
        ...
        if (this.zzc != zzfkVar.zzc) {
            return false;
        }
        float[] fArr = zzfkVar.zzb;
    ...
    public final boolean addAll(Collection<? extends Float> collection) {
        ...
        if (Integer.MAX_VALUE - i2 >= i) {
            ...
            System.arraycopy(zzfkVar.zzb, 0, this.zzb, this.zzc, zzfkVar.zzc);
            this.zzc = i3;
            this.modCount++;
            return true;
        }
    ...
    public final /* synthetic */ zzfx<Float> zza(int i) {
        if (i >= this.zzc) {
            return new zzfk(Arrays.copyOf(this.zzb, i), this.zzc);
        }
    ...
    static {
        zzfk zzfkVar = new zzfk(new float[0], 0);
        zza = zzfkVar;
        zzfkVar.zzb();
    }
}
