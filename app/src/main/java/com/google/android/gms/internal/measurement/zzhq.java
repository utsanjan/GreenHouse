...
public class zzhq<K extends Comparable<K>, V> extends AbstractMap<K, V> {
    private final int zza;
    private List<zzhz> zzb;
    private Map<K, V> zzc;
    private boolean zzd;
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static <FieldDescriptorType extends zzfg<FieldDescriptorType>> zzhq<FieldDescriptorType, Object> zza(int i) {
        return new zzht(i);
    }
    ...
    public boolean containsKey(Object obj) {
        ...
        return zza((zzhq<K, V>) comparable) >= 0 || this.zzc.containsKey(comparable);
    }
    ...
    public V get(Object obj) {
        Comparable comparable = (Comparable) obj;
        int zza = zza((zzhq<K, V>) comparable);
        if (zza >= 0) {
    ...
    public final V zza(K k, V v) {
        ...
        int i2 = this.zza;
        if (size == i2) {
            zzhz remove = this.zzb.remove(i2 - 1);
            zzg().put((K) ((Comparable) remove.getKey()), (V) remove.getValue());
        }
        this.zzb.add(i, new zzhz(this, k, v));
        return null;
    }
    ...
    public final V zzc(int i) {
        ...
        if (!this.zzc.isEmpty()) {
            ...
            this.zzb.add(new zzhz(this, it.next()));
            it.remove();
        }
        return v;
    }
    ...
    public /* synthetic */ Object put(Object obj, Object obj2) {
        return zza((zzhq<K, V>) ((Comparable) obj), (Comparable) obj2);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public /* synthetic */ zzhq(int i, zzht zzhtVar) {
        this(i);
    }
}
