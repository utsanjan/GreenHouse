...
final class zziq extends zzir {
                ...
                if (zzd) {
                    ...
                    if (!zze) {
                        ...
                        if (zzf) {
                            ...
                            int i10 = i9 + 1;
                            i = i10 + 1;
                            zzio.zzb(b2, b4, bArr[i9], bArr[i10], cArr, i5);
                            i5 = i5 + 1 + 1;
                        } else {
                            throw zzfw.zzh();
                        }
    ...
    */
    public final int zza(java.lang.CharSequence r8, byte[] r9, int r10, int r11) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.measurement.zziq.zza(java.lang.CharSequence, byte[], int, int):int");
    }
}
