    ...
    protected final boolean zza(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
        ...
        switch (i) {
            ...
            case 3:
                ...
                logEventAndBundle(readString, readString2, bundle, zzyVar, parcel.readLong());
                break;
            case 4:
            ...
            case 5:
                ...
                if (readStrongBinder2 != null) {
                    ...
                    if (queryLocalInterface2 instanceof zzw) {
                        ...
                        zzwVar = new zzy(readStrongBinder2);
                    }
                }
                getUserProperties(readString3, readString4, zza, zzwVar);
                break;
            case 6:
                ...
                if (readStrongBinder3 != null) {
                    ...
                    if (queryLocalInterface3 instanceof zzw) {
                        zzwVar13 = (zzw) queryLocalInterface3;
                    } else {
                        zzwVar13 = new zzy(readStrongBinder3);
                    }
                }
                getMaxUserProperties(readString5, zzwVar13);
                break;
            case 7:
            ...
            case 10:
                ...
                if (readStrongBinder4 != null) {
                    ...
                    if (queryLocalInterface4 instanceof zzw) {
                        zzwVar12 = (zzw) queryLocalInterface4;
                    } else {
                        zzwVar12 = new zzy(readStrongBinder4);
                    }
                }
                getConditionalUserProperties(readString6, readString7, zzwVar12);
                break;
            case 11:
            ...
            case 16:
                ...
                if (readStrongBinder5 != null) {
                    ...
                    if (queryLocalInterface5 instanceof zzw) {
                        zzwVar11 = (zzw) queryLocalInterface5;
                    } else {
                        zzwVar11 = new zzy(readStrongBinder5);
                    }
                }
                getCurrentScreenName(zzwVar11);
                break;
            case 17:
                ...
                if (readStrongBinder6 != null) {
                    ...
                    if (queryLocalInterface6 instanceof zzw) {
                        zzwVar10 = (zzw) queryLocalInterface6;
                    } else {
                        zzwVar10 = new zzy(readStrongBinder6);
                    }
                }
                getCurrentScreenClass(zzwVar10);
                break;
            case 18:
            ...
            case 19:
                ...
                if (readStrongBinder8 != null) {
                    ...
                    if (queryLocalInterface8 instanceof zzw) {
                        zzwVar9 = (zzw) queryLocalInterface8;
                    } else {
                        zzwVar9 = new zzy(readStrongBinder8);
                    }
                }
                getCachedAppInstanceId(zzwVar9);
                break;
            case 20:
                ...
                if (readStrongBinder9 != null) {
                    ...
                    if (queryLocalInterface9 instanceof zzw) {
                        zzwVar8 = (zzw) queryLocalInterface9;
                    } else {
                        zzwVar8 = new zzy(readStrongBinder9);
                    }
                }
                getAppInstanceId(zzwVar8);
                break;
            case 21:
                ...
                if (readStrongBinder10 != null) {
                    ...
                    if (queryLocalInterface10 instanceof zzw) {
                        zzwVar7 = (zzw) queryLocalInterface10;
                    } else {
                        zzwVar7 = new zzy(readStrongBinder10);
                    }
                }
                getGmpAppId(zzwVar7);
                break;
            case 22:
                ...
                if (readStrongBinder11 != null) {
                    ...
                    if (queryLocalInterface11 instanceof zzw) {
                        zzwVar6 = (zzw) queryLocalInterface11;
                    } else {
                        zzwVar6 = new zzy(readStrongBinder11);
                    }
                }
                generateEventId(zzwVar6);
                break;
            case 23:
            ...
            case 31:
                ...
                if (readStrongBinder12 != null) {
                    ...
                    if (queryLocalInterface12 instanceof zzw) {
                        zzwVar5 = (zzw) queryLocalInterface12;
                    } else {
                        zzwVar5 = new zzy(readStrongBinder12);
                    }
                }
                onActivitySaveInstanceState(asInterface, zzwVar5, parcel.readLong());
                break;
            case 32:
                ...
                if (readStrongBinder13 != null) {
                    ...
                    if (queryLocalInterface13 instanceof zzw) {
                        zzwVar4 = (zzw) queryLocalInterface13;
                    } else {
                        zzwVar4 = new zzy(readStrongBinder13);
                    }
                }
                performAction(bundle2, zzwVar4, parcel.readLong());
                break;
            case 33:
            ...
            case 38:
                ...
                if (readStrongBinder17 != null) {
                    ...
                    if (queryLocalInterface17 instanceof zzw) {
                        zzwVar3 = (zzw) queryLocalInterface17;
                    } else {
                        zzwVar3 = new zzy(readStrongBinder17);
                    }
                }
                getTestFlag(zzwVar3, parcel.readInt());
                break;
            case 39:
            ...
            case 40:
                ...
                if (readStrongBinder18 != null) {
                    ...
                    if (queryLocalInterface18 instanceof zzw) {
                        zzwVar2 = (zzw) queryLocalInterface18;
                    } else {
                        zzwVar2 = new zzy(readStrongBinder18);
                    }
                }
                isDataCollectionEnabled(zzwVar2);
                break;
            case 41:
            default:
                return false;
