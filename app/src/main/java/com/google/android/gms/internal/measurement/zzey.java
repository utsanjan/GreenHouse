...
final class zzey implements zzja {
    ...
    @Override // com.google.android.gms.internal.measurement.zzja
    public final void zza(int i, Object obj, zzhp zzhpVar) throws IOException {
    ...
    public final void zzb(int i, Object obj, zzhp zzhpVar) throws IOException {
        ...
        zzevVar.zza(i, 3);
        zzhpVar.zza((zzhp) ((zzgw) obj), (zzja) zzevVar.zza);
        zzevVar.zza(i, 4);
    }
    ...
    public final void zza(int i, List<Integer> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            for (int i4 = 0; i4 < list.size(); i4++) {
                i3 += zzev.zzf(list.get(i4).intValue());
            }
            this.zza.zzb(i3);
            while (i2 < list.size()) {
    ...
    public final void zzb(int i, List<Integer> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = 0;
            for (int i4 = 0; i4 < list.size(); i4++) {
                i3 += zzev.zzi(list.get(i4).intValue());
            }
            this.zza.zzb(i3);
            while (i2 < list.size()) {
    ...
    public final void zzc(int i, List<Long> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = 0;
            for (int i4 = 0; i4 < list.size(); i4++) {
                i3 += zzev.zzd(list.get(i4).longValue());
            }
            this.zza.zzb(i3);
            while (i2 < list.size()) {
    ...
    public final void zzd(int i, List<Long> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = 0;
            for (int i4 = 0; i4 < list.size(); i4++) {
                i3 += zzev.zze(list.get(i4).longValue());
            }
            this.zza.zzb(i3);
            while (i2 < list.size()) {
                this.zza.zza(list.get(i2).longValue());
    ...
    public final void zze(int i, List<Long> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = 0;
            for (int i4 = 0; i4 < list.size(); i4++) {
                i3 += zzev.zzg(list.get(i4).longValue());
            }
            this.zza.zzb(i3);
            while (i2 < list.size()) {
    ...
    public final void zzf(int i, List<Float> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = 0;
            for (int i4 = 0; i4 < list.size(); i4++) {
                i3 += zzev.zzb(list.get(i4).floatValue());
            }
            this.zza.zzb(i3);
            while (i2 < list.size()) {
    ...
    public final void zzh(int i, List<Integer> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = 0;
            for (int i4 = 0; i4 < list.size(); i4++) {
                i3 += zzev.zzk(list.get(i4).intValue());
            }
            this.zza.zzb(i3);
            while (i2 < list.size()) {
                this.zza.zza(list.get(i2).intValue());
    ...
    public final void zzi(int i, List<Boolean> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = 0;
            for (int i4 = 0; i4 < list.size(); i4++) {
                i3 += zzev.zzb(list.get(i4).booleanValue());
            }
            this.zza.zzb(i3);
            while (i2 < list.size()) {
    ...
    public final void zza(int i, List<String> list) throws IOException {
        ...
        if (list instanceof zzgh) {
            ...
            while (i2 < list.size()) {
                Object zzb = zzghVar.zzb(i2);
                if (zzb instanceof String) {
                    this.zza.zza(i, (String) zzb);
                } else {
                    this.zza.zza(i, (zzeg) zzb);
                }
                i2++;
            }
            return;
    ...
    @Override // com.google.android.gms.internal.measurement.zzja
    public final void zzb(int i, List<zzeg> list) throws IOException {
    ...
    public final void zzj(int i, List<Integer> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = 0;
            for (int i4 = 0; i4 < list.size(); i4++) {
                i3 += zzev.zzg(list.get(i4).intValue());
            }
            this.zza.zzb(i3);
            while (i2 < list.size()) {
    ...
    public final void zzk(int i, List<Integer> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = 0;
            for (int i4 = 0; i4 < list.size(); i4++) {
                i3 += zzev.zzj(list.get(i4).intValue());
            }
            this.zza.zzb(i3);
            while (i2 < list.size()) {
                this.zza.zzd(list.get(i2).intValue());
    ...
    public final void zzl(int i, List<Long> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = 0;
            for (int i4 = 0; i4 < list.size(); i4++) {
                i3 += zzev.zzh(list.get(i4).longValue());
            }
            this.zza.zzb(i3);
            while (i2 < list.size()) {
                this.zza.zzc(list.get(i2).longValue());
    ...
    public final void zzm(int i, List<Integer> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = 0;
            for (int i4 = 0; i4 < list.size(); i4++) {
                i3 += zzev.zzh(list.get(i4).intValue());
            }
            this.zza.zzb(i3);
            while (i2 < list.size()) {
    ...
    public final void zzn(int i, List<Long> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = 0;
            for (int i4 = 0; i4 < list.size(); i4++) {
                i3 += zzev.zzf(list.get(i4).longValue());
            }
            this.zza.zzb(i3);
            while (i2 < list.size()) {
    ...
    @Override // com.google.android.gms.internal.measurement.zzja
    public final void zza(int i, List<?> list, zzhp zzhpVar) throws IOException {
        for (int i2 = 0; i2 < list.size(); i2++) {
    ...
    @Override // com.google.android.gms.internal.measurement.zzja
    public final <K, V> void zza(int i, zzgr<K, V> zzgrVar, Map<K, V> map) throws IOException {
