...
public final class zzfp extends zzea<Integer> implements zzfv, zzhi, RandomAccess {
    ...
    public final boolean equals(Object obj) {
        ...
        if (this.zzc != zzfpVar.zzc) {
            return false;
        }
        int[] iArr = zzfpVar.zzb;
    ...
    public final zzfv zza(int i) {
        if (i >= this.zzc) {
            return new zzfp(Arrays.copyOf(this.zzb, i), this.zzc);
        }
    ...
    public final boolean addAll(Collection<? extends Integer> collection) {
        ...
        if (Integer.MAX_VALUE - i2 >= i) {
            ...
            System.arraycopy(zzfpVar.zzb, 0, this.zzb, this.zzc, zzfpVar.zzc);
            this.zzc = i3;
            this.modCount++;
            return true;
        }
    ...
    static {
        zzfp zzfpVar = new zzfp(new int[0], 0);
        zza = zzfpVar;
        zzfpVar.zzb();
    }
}
