...
public class zzki<K extends Comparable<K>, V> extends AbstractMap<K, V> {
    private final int zza;
    private List<zzkn> zzb;
    private Map<K, V> zzc;
    private boolean zzd;
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static <FieldDescriptorType extends zzhx<FieldDescriptorType>> zzki<FieldDescriptorType, Object> zza(int i) {
        return new zzkh(i);
    }
    ...
    public boolean containsKey(Object obj) {
        ...
        return zza((zzki<K, V>) comparable) >= 0 || this.zzc.containsKey(comparable);
    }
    ...
    public V get(Object obj) {
        Comparable comparable = (Comparable) obj;
        int zza = zza((zzki<K, V>) comparable);
        if (zza >= 0) {
    ...
    public final V zzc(int i) {
        ...
        if (!this.zzc.isEmpty()) {
            ...
            this.zzb.add(new zzkn(this, it.next()));
            it.remove();
        }
        return v;
    }
    ...
    public boolean equals(Object obj) {
        ...
        int size = size();
        if (size != zzkiVar.size()) {
            return false;
        }
        int zzc = zzc();
        if (zzc != zzkiVar.zzc()) {
            return entrySet().equals(zzkiVar.entrySet());
        }
        for (int i = 0; i < zzc; i++) {
            if (!zzb(i).equals(zzkiVar.zzb(i))) {
                return false;
            }
        }
        if (zzc != size) {
            return this.zzc.equals(zzkiVar.zzc);
        }
        return true;
    }
    ...
    public /* synthetic */ Object put(Object obj, Object obj2) {
        return zza((zzki<K, V>) ((Comparable) obj), (Comparable) obj2);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public /* synthetic */ zzki(int i, zzkh zzkhVar) {
        this(i);
    }
}
