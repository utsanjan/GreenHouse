...
public final class CodedOutputStream implements Flushable {
    ...
    public void writeRawBytes(byte[] value, int offset, int length) throws IOException {
        ...
        System.arraycopy(value, offset, this.buffer, i2, bytesWritten);
    ...
    public void writeRawBytes(ByteString value, int offset, int length) throws IOException {
        ...
        int i2 = this.position;
        if (i - i2 >= length) {
            value.copyTo(this.buffer, offset, i2, length);
            this.position += length;
            return;
        }
        int bytesWritten = i - i2;
        value.copyTo(this.buffer, offset, i2, bytesWritten);
        int offset2 = offset + bytesWritten;
        int length2 = length - bytesWritten;
        this.position = this.limit;
        refreshBuffer();
        ...
        if (offset2 == inputStreamFrom.skip(offset2)) {
            while (length2 > 0) {
