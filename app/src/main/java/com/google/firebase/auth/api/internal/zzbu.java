...
public final class zzbu extends zzfe<AuthResult, zza> {
    ...
    public final TaskApiCall<zzef, AuthResult> zzb() {
        return TaskApiCall.builder().setAutoResolveMissingFeatures(false).setFeatures((this.zzu || this.zzv) ? null : new Feature[]{zze.zza}).run(new RemoteCall(this) { // from class: com.google.firebase.auth.api.internal.zzbt
    ...
    public final /* synthetic */ void zza(zzef zzefVar, TaskCompletionSource taskCompletionSource) throws RemoteException {
        ...
        zzdp zzdpVar = new zzdp(this.zza.zza(this.zze));
        if (this.zzu) {
            zzefVar.zza().zza(zzdpVar.zza(), this.zzc);
        } else {
            zzefVar.zza().zza(zzdpVar, this.zzc);
        }
    }
}
