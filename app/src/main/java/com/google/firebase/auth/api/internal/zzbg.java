...
public final class zzbg extends zzfe<SignInMethodQueryResult, zza> {
    ...
    public final TaskApiCall<zzef, SignInMethodQueryResult> zzb() {
        return TaskApiCall.builder().setAutoResolveMissingFeatures(false).setFeatures((this.zzu || this.zzv) ? null : new Feature[]{zze.zza}).run(new RemoteCall(this) { // from class: com.google.firebase.auth.api.internal.zzbf
    ...
    public final /* synthetic */ void zza(zzef zzefVar, TaskCompletionSource taskCompletionSource) throws RemoteException {
        ...
        if (this.zzu) {
            zzefVar.zza().zzc(this.zza.zza(), this.zzc);
        } else {
