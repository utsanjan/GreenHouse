...
public class AnimatorInflaterCompat {
        ...
        if (valueType2 == 2) {
            ...
            if (getFloats) {
                if (hasFrom) {
                    ...
                    if (hasTo) {
                        float valueTo4 = toType2 == 5 ? styledAttributes.getDimension(valueToId, 0.0f) : styledAttributes.getFloat(valueToId, 0.0f);
    ...
    /* JADX WARN: Code restructure failed: missing block: B:41:0x010c, code lost:
        if (r3.hasNext() == false) goto L_0x011a;
     */
            ...
            if (size > 0) {
                ...
                while (i < count) {
                    ...
                    if (keyframe2.getFraction() >= f) {
                        ...
                        int j2 = endIndex + 1;
                        float gap = keyframeArray[j2].getFraction() - keyframeArray[i - 1].getFraction();
