    ...
    */
    public AppCompatSpinner(android.content.Context r7, android.util.AttributeSet r8, int r9, int r10, android.content.res.Resources.Theme r11) {
        ...
        L_0x0034:
            ...
            r2 = 0
            int[] r3 = androidx.appcompat.widget.AppCompatSpinner.ATTRS_ANDROID_SPINNERMODE     // Catch: all -> 0x0050, Exception -> 0x0052
            android.content.res.TypedArray r3 = r7.obtainStyledAttributes(r8, r3, r9, r1)     // Catch: all -> 0x0050, Exception -> 0x0052
            r2 = r3
            boolean r3 = r2.hasValue(r1)     // Catch: all -> 0x0050, Exception -> 0x0052
            if (r3 == 0) goto L_0x004a
            int r3 = r2.getInt(r1, r1)     // Catch: all -> 0x0050, Exception -> 0x0052
            r10 = r3
        L_0x004a:
