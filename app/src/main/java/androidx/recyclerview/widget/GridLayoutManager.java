...
public class GridLayoutManager extends LinearLayoutManager {
    ...
    public View onFocusSearchFailed(View focused, int focusDirection, RecyclerView.Recycler recycler, RecyclerView.State state) {
        ...
        int focusableWeakCandidateSpanIndex2 = 0;
            ...
            if (!candidate.hasFocusable() || spanGroupIndex == focusableSpanGroupIndex2) {
                ...
                if ((!candidate.hasFocusable() || focusableWeakCandidate != null) && (candidate.hasFocusable() || unfocusableWeakCandidate != null)) {
                    ...
                    if (!candidate.hasFocusable()) {
                        focusableWeakCandidateSpanIndex = focusableWeakCandidateSpanIndex;
                        if (focusableWeakCandidate == null) {
                            focusableWeakCandidateOverlap = focusableWeakCandidateSpanIndex2;
                            boolean z = false;
                        ...
                        overlap = 0;
                    } else if (overlap2 > focusableWeakCandidateSpanIndex2) {
                        focusableWeakCandidateSpanIndex = focusableWeakCandidateSpanIndex;
                        focusableWeakCandidateOverlap = focusableWeakCandidateSpanIndex2;
                        overlap = 1;
                    } else {
                        if (overlap2 == focusableWeakCandidateSpanIndex2) {
                            focusableWeakCandidateSpanIndex = focusableWeakCandidateSpanIndex;
                            boolean focusableWeakCandidateSpanIndex3 = candidateStart > focusableWeakCandidateSpanIndex;
                ...
                if (overlap != 0) {
                    if (candidate.hasFocusable()) {
                        ...
                        focusableWeakCandidateSpanIndex2 = Math.min(candidateEnd, prevSpanEnd) - Math.max(candidateStart, prevSpanStart);
                        focusableWeakCandidate = candidate;
                        focusableWeakCandidateSpanIndex = focusableWeakCandidateSpanIndex4;
                    } else {
                        ...
                        focusableWeakCandidateSpanIndex2 = focusableWeakCandidateOverlap;
                    }
                    i += inc;
                    recycler2 = recycler;
                    state2 = state;
