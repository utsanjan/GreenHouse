...
public class Analyzer {
    ...
    private static int getMaxDimensionTraversal(ConstraintWidget widget, int orientation, boolean topLeftFlow, int depth) {
        ...
        while (it2.hasNext()) {
            ...
            dimensionPost3 = Math.max(dimensionPost3, getMaxDimensionTraversal(((ResolutionAnchor) targetNode2).myAnchor.mOwner, orientation, topLeftFlow, postTemp3 + dimension2));
            it2 = it2;
            endOffset = endOffset;
        }
        if (hasBaseline) {
