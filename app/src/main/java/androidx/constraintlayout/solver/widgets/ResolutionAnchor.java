        ...
        if (this.state != 1 && this.type != 4) {
            ...
            if (this.type == 1 && ((resolutionAnchor7 = this.target) == null || resolutionAnchor7.state == 1)) {
                ...
                if (isEndAnchor) {
                    ...
                    resolutionAnchor10.resolvedOffset = resolutionAnchor10.target.resolvedOffset + oppositeMargin + (distance3 * percent);
                    ...
                    resolutionAnchor11.resolvedOffset = (resolutionAnchor11.target.resolvedOffset - oppositeMargin) - ((1.0f - percent) * distance3);
                }
                didResolve();
