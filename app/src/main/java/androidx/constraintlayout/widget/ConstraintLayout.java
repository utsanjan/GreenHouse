            ...
            if (widget2 == null) {
                ...
                if (layoutParams2.helped) {
                    ...
                    try {
                        ...
                        int i10 = z ? 1 : 0;
                        int i11 = z ? 1 : 0;
                        setDesignInformation(i9, IdAsString2, valueOf);
                ...
                if (layoutParams2.isGuideline) {
                    ...
                    if (layoutParams2.circleConstraint != -1) {
                        ...
                        if (resolvedLeftToLeft2 != -1) {
                            ...
                            resolvedRightToLeft2 = resolvedRightToRight;
                            layoutParams = layoutParams2;
                            if (!(resolveGoneLeftMargin == -1 || (target4 = getTargetWidget(resolveGoneLeftMargin)) == null)) {
                    ...
                    if (width3 == 0 || height3 == 0) {
                        ...
                        if (width3 != 0 || height3 != 0 || !bothHorizontal || !bothVertical) {
                            ...
                            if (height3 != 0) {
                                ...
                                int childHeightMeasureSpec3 = getChildMeasureSpec(parentHeightSpec, heightPadding2, -2);
                                didWrapMeasureHeight2 = USE_CONSTRAINTS_HELPER;
                                resolveHeight = false;
